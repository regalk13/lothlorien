...
let
  ...
  illogical-impulse-dotfiles =
    inputs.illogical-impulse-dotfiles or /home/regalk/illogical-impulse-dotfiles;
in
{
  #imports = [
  #  ./extra.nix
  ...
  config = lib.mkMerge [
    ...
    (lib.mkIf cfg.end4s.enable {
      ...
      xdg.configFile = {
        ...
        "hypr/hyprland/execs.conf".source =
          "${illogical-impulse-dotfiles}/.config/hypr/hyprland/execs.conf";
        "hypr/hyprland/general.conf".source =
          "${illogical-impulse-dotfiles}/.config/hypr/hyprland/general.conf";
        "hypr/hyprland/rules.conf".source =
          "${illogical-impulse-dotfiles}/.config/hypr/hyprland/rules.conf";
        "hypr/hyprland/keybinds.conf".source =
          "${illogical-impulse-dotfiles}/.config/hypr/hyprland/keybinds.conf";
        "hypr/hyprland/colors.conf".source =
          "${illogical-impulse-dotfiles}/.config/hypr/hyprland/colors.conf";
