...
*** [[https://spectrum.ieee.org/feeds/topic/computing.rss][IEEE Computing]]
** Mathematics :math:
*** [[https://terrytao.wordpress.com/feed/][Terence Tao]]
*** [[https://www.quantamagazine.org/tag/mathematics/feed/][Quanta Magazine (Math)]] :science:
*** [[https://jeremykun.com/feed/][Jeremy Kun]] :algorithms:
*** [[https://www.quantamagazine.org/feed/][Quanta Magazine (All)]] :science:
*** [[https://betterexplained.com/feed/][Better Explained]] :education:
*** [[https://www.math3ma.com/blog/feed.xml][Math3ma]]
** Linux
*** [[https://lwn.net/headlines/rss][LWN.net]] :linux:
*** [[https://www.cyberciti.com/atom/atom.xml][NixCraft (CyberCiti)]] :linux:news:
*** [[https://computer.rip/rss.xml][Computers Are Bad]]
*** [[https://itsfoss.com/feed/][It's FOSS]]
*** [[https://www.phoronix.com/rss.php][Phoronix]] :hardware:
...
*** [[https://eli.thegreenplace.net/feeds/all.atom.xml][Eli Bendersky]] :math:systems:
*** [[https://rachelbythebay.com/w/atom.xml][Rachel by the Bay]] :systems:

*** Systems & Low Level :systems:c:
**** [[https://nullprogram.com/feed/][Null Program]]
**** [[https://queue.acm.org/rss/feeds/queuecontent.xml][ACM Queue]]
**** [[https://andrewkelley.me/rss.xml][Andrew Kelley (Zig)]] :zig:
**** [[https://priver.dev/blog/index.xml][Priver]] :rust:functional:
**** [[https://geohot.github.io/blog/feed.xml][George Hotz]] :singularity:
**** [[https://www.rfleury.com/feed][Ryan Fleury]]
**** [[https://commandpattern.org/feed/][Command Pattern]] :robotics:
**** [[https://ludwigabap.bearblog.dev/feed/][Ludwig]] :ml:
**** [[https://regalk.dev/posts.rss][RegalK]] :hpc:
**** [[https://articles.haskell.org/feed][Haskell Weekly]]
**** [[https://cpu.land/rss.xml][Cpu.land]]

*** Rust :rust:
**** [[https://blog.rust-lang.org/feed.xml][Rust Core Blog]]
**** [[https://this-week-in-rust.org/rss.xml][This Week in Rust]]
**** [[https://fasterthanli.me/index.xml][Fasterthanli.me]]
**** [[https://blog.m-ou.se/index.xml][Mara's Blog]]

*** Embedded & Firmware :embedded:
**** [[https://interrupt.memfault.com/feed.xml][Interrupt]]
**** [[https://embeddedartistry.com/feed/][Embedded Artistry]]
**** [[https://porzechowski.github.io/blog/feed.xml][Phillip Orzechowski]]
**** [[https://www.ganssle.com/blog/feed.rss][Jack Ganssle]]
**** [[https://hackaday.com/blog/feed/][Hackaday]]

*** Security :pentesting:
**** [[https://128nops.blogspot.com/rss.xml][128nops]]
**** [[https://googleprojectzero.blogspot.com/feeds/posts/default][Google Project Zero]]
**** [[https://doar-e.github.io/feeds/rss.xml][Doar-e]]
...
*** [[http://lesserwrong.com/feed.xml][Lesser Wrong]] :ai:singularity:
...
** YouTube :youtube:
*** Technology :tech:
**** [[https://rsshub.app/youtube/user/@LukeSmithxyz][Luke Smith]]
**** [[https://www.youtube.com/feeds/videos.xml?channel_id=UCg0V1MkdYkMlwZPU3IuKLMg][Valigo]]
...
**** [[https://www.youtube.com/feeds/videos.xml?channel_id=UCJ0yBou72Lz9fqeMXh9mkog][Ben Eater]]
**** [[https://www.youtube.com/feeds/videos.xml?channel_id=UC2C_jShtL725hvW2URI_81g][LiveOverflow]] 
